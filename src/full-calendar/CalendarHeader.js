...
var CalendarHeader = function (_Component) {
  ...
  CalendarHeader.prototype.yearSelectElement = function yearSelectElement(year) {
    ...
    for (var index = start; index < end; index++) {
      options.push(React.createElement(Select.Option, { key: '' + index }, index));
    }
  ...
  CalendarHeader.prototype.monthSelectElement = function monthSelectElement(month) {
    ...
    for (var index = 0; index < 12; index++) {
      t.month(index);
      options.push(React.createElement(Select.Option, { key: '' + index }, getMonthName(t)));
    }
  ...
  CalendarHeader.prototype.render = function render() {
    ...
    var typeSwitcher = showTypeSwitch ? React.createElement('span', { className: switchCls }, type === 'date' ? React.createElement('span', { className: switchCls + '-focus' }, locale.month) : React.createElement('span', {
      onClick: this.changeTypeToDate.bind(this),
      className: switchCls + '-normal'
    }, locale.month), type === 'month' ? React.createElement('span', { className: switchCls + '-focus' }, locale.year) : React.createElement('span', {
      onClick: this.changeTypeToMonth.bind(this),
      className: switchCls + '-normal'
    }, locale.year)) : null;

    return React.createElement('div', { className: prefixCls + '-header' }, typeSwitcher, monthSelect, yearSelect, headerComponents);
  };
