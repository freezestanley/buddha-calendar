  ...
  render: function render() {
    ...
    if (props.showToday || timePicker || extraFooter) {
      ...
      if (nowEl || timePickerBtn || okBtn) {
        footerBtn = React.createElement('span', { className: prefixCls + '-footer-btn' }, toFragment([nowEl, timePickerBtn, okBtn]));
      }
      var cls = cx((_cx = {}, _cx[prefixCls + '-footer'] = true, _cx[prefixCls + '-footer-show-ok'] = okBtn, _cx));
      footerEl = React.createElement('div', { className: cls }, extraFooter, footerBtn);
    }
    return footerEl;
  }
});
